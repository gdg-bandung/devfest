export const FAQ_LIST: { id: string; question: string; answer: any }[] = [
  {
    id: "faq-1",
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <strong class="font-bold">do not arrive late</strong> because you will
        miss many exclusive opportunities from our events.
      </>
    ),
  },
  {
